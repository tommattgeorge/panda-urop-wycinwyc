...
bool enable_callstack_tracking(void* self, panda_cb pcb){
    ...
    pcb.after_block_exec =(void (*)(CPUState*, TranslationBlock*, uint8_t)) after_block_exec_callstack_cb;
    panda_register_callback(self, PANDA_CB_AFTER_BLOCK_EXEC, pcb);

    pcb.before_block_exec =(void (*)(CPUState*, TranslationBlock*)) before_block_exec_callstack_cb;
