...
bool enable_callframe_tracking(void* self, panda_cb pcb){
    ...
    pcb.phys_mem_before_write =(void (*)(CPUState*, target_ptr_t, target_ptr_t, size_t, uint8_t*)) phys_mem_write_callframe_cb;
    panda_register_callback(self, PANDA_CB_PHYS_MEM_BEFORE_WRITE, pcb);

    pcb.after_block_exec =(void (*)(CPUState*, TranslationBlock*, uint8_t)) after_block_exec_callframe_cb;
    panda_register_callback(self, PANDA_CB_AFTER_BLOCK_EXEC, pcb);

    pcb.before_block_exec =(void (*)(CPUState*, TranslationBlock*)) before_block_exec_callframe_cb;
